...
blurred = np.hstack([
	...
	cv2.blur(image, (5, 5)),
	cv2.blur(image, (7, 7))])
cv2.imwrite('definitionAveragedImg.jpg',blurred)
...
cv2.imwrite('definitionGaussianImg.jpg',blurred)
...
cv2.imwrite('definitionMedianImg.jpg',blurred)
...
cv2.imwrite('definitionBilateralImg.jpg',blurred)
